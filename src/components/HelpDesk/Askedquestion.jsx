      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <motion.div
          className={`
            ...
            w-72 bg-gray-800 overflow-y-auto flex-shrink-0 border rounded-lg md:ml-2 sm:mt-10 md:mt-0 border-gray-700
        ...
        <div
          ref={contentRef}
          className={`flex-1 overflow-y-auto p-4 md:p-6 transition-all duration-300 ${isMobile && sidebarOpen ? "opacity-50" : "opacity-100"}`}
        >
          <LayoutGroup>
            {filteredFAQs.map(
              (category) =>
                category.id === activeCategory && (
                  ...
                  >
                    <motion.h1
                      className="text-2xl md:text-3xl font-bold mb-4 md:mb-8 text-white flex items-center sm:mt-4 md:mt-0"
                        ...
                        >
                          <motion.div
                            ...
                            className={`p-4 md:p-6 rounded-lg cursor-pointer transition-colors relative border-2 ${
                              openQuestionId === questionId
                                ...
                                : "bg-gray-800 border-transparent hover:border-teal-500"
                            }`}
                            whileHover={{ scale: 1.01 }}
                            whileTap={{ scale: 0.99 }}
                          >
                            <div className="flex justify-between items-center">
                              <h2 className="text-base md:text-xl font-semibold text-white pr-8">{`${qIndex + 1}. ${item.question}`}</h2>
                              <motion.div
                                animate={{ rotate: openQuestionId === questionId ? 180 : 0 }}
                          ...
                          <AnimatePresence>
                            {openQuestionId === questionId && (
                              ...
                              >
                                <div className="p-4 md:p-6 bg-gray-700 border border-teal-300 rounded-lg mt-1">

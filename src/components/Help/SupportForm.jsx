...
const ChatApp = () => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      const responses = [
        ...
        "I understand. Let me see what I can do.",
        "Perfect! I'll make a note of that.",
        "Thanks for the update. Is there anything else you need?  I'll make a note of that.",
        "Thanks for the update. Is there anything else you need?",
      ]
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-900 text-white overflow-hidden">
      ...
      {(showMobileChats || window.innerWidth >= 768) && (
        <div
          className={`md:w-1/3 w-full bg-gray-800 border-r border-gray-700 flex flex-col ${!showMobileChats && "hidden md:flex"} h-full`}
        >
          {/* Header */}
          <div className="p-4 border-b border-gray-700 bg-gray-800 flex items-center justify-between">
            <h2 className="text-xl font-semibold">{userRole === "recruiter" ? "Candidates" : "Recruiters"}</h2>
      ...
      {/* Chat Window */}
      {selectedChat ? (
        <div className="flex-1 flex flex-col bg-gray-900 relative h-full sm:mt-4 md:mt-0 ">
          {/* Chat Header */}
          <div className="p-3 border-b border-gray-700 bg-gray-800 flex items-center justify-between sticky top-0 z-10">
            <div className="flex items-center gap-3">
              <button
          ...
          <div className="p-3 border-t border-gray-700 bg-gray-800 relative">
            ...
            <div className="flex items-center">
              ...
              <input
                type="text"
                className="flex-1 mx-2 md:px-4 md:py-2 sm:px-1 sm:py-2 sm:w-10 border border-gray-600 rounded-lg bg-gray-700 text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
                value={newMessage}
                onChange={(e) => setNewMessage(e.target.value)}
                onKeyDown={handleKeyPress}
                placeholder="Type a message..."

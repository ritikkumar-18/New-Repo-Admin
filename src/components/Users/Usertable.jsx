...
const userData = [
  ...
  { id: 10, name: "Frank White", email: "frank@example.com", status: "Active", joined: "2020-07-25", contact: "123-789-4567", address: "707 Maple St, Springfield" },   { id: 11, name: "Grace Lee", email: "grace@example.com", status: "Active", joined: "2023-02-14", contact: "555-333-6666", address: "808 Oak St, Springfield" },
...
const Usertable = () => {
  ...
  return (
    <motion.div
      className="flex-1 bg-gray-900 relative mt-4"
      ...
      <motion.div
          ...
          <div className="flex items-center space-x-4">
            ...
            <span
              className={`text-sm font-semibold ${
                selectedUser.status === "Active" ? "text-green-400" : selectedUser.status === "Pending" ? "text-yellow-400" : "text-red-400"
              }`}>
              {selectedUser.status}
            </span>
          </div>
        ...
        <div className="mt-6 flex justify-center">
          <button
            ...
            onClick={closeSlider}>Close</button>
        </div>
      </motion.div>
    </motion.div>
  )}

...
const userData = [
  {
    ...
    verificationDocuments: {
      ...
      gstCertificate: true,
      panCardUrl: "https://t4.ftcdn.net/jpg/06/20/32/15/240_F_620321511_fodPcaOudj9jTg1Fo6wybZWJM91IaKIp.jpg",
      msmeCertificateUrl: "https://imgs.search.brave.com/jM3-YUHX353eAK4vlD_dAWaJKDUK4lMZS12Zp6v7JoA/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9hc3Nl/dHMxLmNsZWFydGF4/LWNkbi5jb20vZmlu/Zm8vd2ctdXRpbHMv/cmV0b29sL2U5YjMy/ODMyLTlkNjItNGQ0/Mi1hZjg0LWFmYjUy/ZmJkNGU4YS5QTkc",
      gstCertificateUrl: "https://t4.ftcdn.net/jpg/06/20/32/15/240_F_620321511_fodPcaOudj9jTg1Fo6wybZWJM91IaKIp.jpg",
      panCardFile: null,
...
const Usertable = () => {
  ...
  const msmeCertificateFileInputRef = useRef(null)
  const gstCertificateFileInputRef = useRef(null)
  const editPanCardFileInputRef = useRef(null)
  const editMsmeCertificateFileInputRef = useRef(null)
  const editGstCertificateFileInputRef = useRef(null)
  ...
  // Handle file uploads for edited user
  const handleFileChange = (e, fileType) => {
    ...
    if (file) {
      if (fileType === "panCard") {
      ...
      } else if (fileType === "msmeCertificate") {
        setEditUser({
          ...editUser,
          verificationDocuments: {
            ...editUser.verificationDocuments,
            msmeCertificateFile: file,
            msmeCertificateUrl: URL.createObjectURL(file),
            msmeCertificate: true,
          },
        })
        ...
        setEditUser({
          ...
          verificationDocuments: {
            ...
            gstCertificateUrl: URL.createObjectURL(file),
            gstCertificate: true,
          },
        })
      }
                ...
                <div className="bg-gray-800 rounded-xl p-5 border border-gray-700 shadow-lg">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    {selectedUser.verificationDocuments?.panCard && selectedUser.verificationDocuments?.panCardUrl ? (
                      ...
                      <div className="flex flex-col items-center justify-center h-32 mb-4 bg-gray-700 rounded-md text-gray-400">
                        <FileX size={24} />
                    ...
                    selectedUser.verificationDocuments?.gstCertificateUrl ? (
                      ...
                      <div className="flex flex-col items-center justify-center h-32 bg-gray-700 rounded-md text-gray-400">
                        <FileX size={24} />
                        <p className="text-sm mt-2">Document not provided</p>
                      </div>
                    )}
                        ...
                        <div>
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                type="button"
                                onClick={() => editPanCardFileInputRef.current.click()}
                              ...
                              >
                                <Upload size={16} />
                                {editUser.verificationDocuments.panCardUrl ? "Change PAN Card" : "Upload PAN Card"}
                              </button>
                            </div>
                            {editUser.verificationDocuments?.panCardUrl && (
                      ...
                      {editUser.verificationDocuments?.msmeCertificate && (
                        <div>
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                              <input
                                ref={editMsmeCertificateFileInputRef}
                                type="file"
                                accept="image/*"
                                className="hidden"
                              ...
                              <button
                                type="button"
                                onClick={() => editMsmeCertificateFileInputRef.current.click()}
                                className="w-full flex items-center justify-center gap-2 p-2 bg-gray-700 text-white rounded border border-gray-600 hover:bg-gray-600 transition-colors"
                              >
                                <Upload size={16} />
                                {editUser.verificationDocuments.msmeCertificateUrl ? "Change MSME Certificate" : "Upload MSME Certificate"}
                              </button>
                            </div>
                            {editUser.verificationDocuments?.msmeCertificateUrl && (
                              <div className="relative mt-2">
                      ...
                      {editUser.verificationDocuments?.gstCertificate && (
                        <div>
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                              <input
                                ref={editGstCertificateFileInputRef}
                                type="file"
                                accept="image/*"
                                className="hidden"
                              ...
                              <button
                                type="button"
                                onClick={() => editGstCertificateFileInputRef.current.click()}
                                className="w-full flex items-center justify-center gap-2 p-2 bg-gray-700 text-white rounded border border-gray-600 hover:bg-gray-600 transition-colors"
                              >
                                <Upload size={16} />
                                {editUser.verificationDocuments.gstCertificateUrl ? "Change GST Certificate" : "Upload GST Certificate"}
                              </button>
                            </div>
                            {editUser.verificationDocuments?.gstCertificateUrl && (
                              <div className="relative mt-2">

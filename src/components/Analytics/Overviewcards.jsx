...
import { DollarSign, Users, Eye, ArrowDownRight, ArrowUpRight, Wallpaper } from "lucide-react";
import { BiWalk } from 'react-icons/bi';

const overviewData = [
	{ name: "Revenue", value: "$1,234,567", change: 12.5, icon: DollarSign },
	{ name: "Users", value: "45,678", change: 8.3, icon: Users },
	{ name: "Visitors", value: "9,876", change: -3.2, icon: BiWalk},
    ...
    <div className='grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8'>
			{overviewData.map((item, index) => (
				<motion.div
                    ...
                    rounded-xl p-6 border border-gray-700 '	whileHover={{ y: -5, boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.5)" }}

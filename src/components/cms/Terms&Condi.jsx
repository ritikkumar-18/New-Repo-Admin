...
const Terms = () => {
  ...
  const [content, setContent] = useState(
    "<h2>Terms & Conditions</h2><p>Your Terms & Conditions are important to us...</p>"
  );
  ...
  const handleDeletePolicy = (index) => {
    ...
    toast.success("Terms & Conditions entry deleted successfully.");
  };
  ...
  const handleExport = () => {
    ...
    link.href = url;
    link.download = "Terms_And_Conditions_Backup.txt";
    link.click();
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="mt-6 space-y-4">
          {filteredPolicies.length > 0 ? (
            ...
            <p className="text-gray-400 text-center">No Terms & Conditions entries found.</p>
          )}
        </div>
      </div>
    </div>

...
const Paymentpolicy = () => {
  const [privacyPolicies, setPrivacyPolicies] = useState(() => 
    ...
    const [content, setContent] = useState("<h2>Payment Policy</h2><p>Your Payment Policy content goes here...</p>");
    ...
    const handleCreatePolicy = () => {
      ...
      if (!cleanContent || cleanContent === "<p><br></p>") {
        toast.error("Payment Policy content cannot be empty!");
        return;
      }
    ...
    const handleDeletePolicy = (index) => {
      ...
      toast.success("Payment Policy entry deleted successfully.");
    };
    ...
    const handleExport = () => {
      ...
      link.href = url;
      link.download = "About_Us_Backup.txt";
      link.click();
      ...
      <div className="flex-1 overflow-auto relative z-10 bg-gray-900 min-h-screen">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            >
              <FiPlusCircle /> Create Payment Policy
            </button>
          </div>
          ...
          <div className="mt-6 space-y-4">
            {filteredPolicies.length > 0 ? (
              ...
              <p className="text-gray-400 text-center">No Payment Policy entries found.</p>
            )}
          </div>
        </div>
      </div>

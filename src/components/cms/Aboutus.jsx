...
const About = () => {
  ...
  const [content, setContent] = useState("<h2>About Us</h2><p>Your About Us is important to us...</p>");
  ...
  const handleCreatePolicy = () => {
    if (!content.trim()) {
      toast.error("About Us cannot be empty!");
      return;
    }
    ...
    <div className="flex-1 overflow-auto relative z-10 bg-gray-900 min-h-screen ">
      ...
      <div className="mt-6">
        {privacyPolicies.length > 0 ? (
          ...
          <p className="text-gray-400 text-center">No About Us created yet.</p>
        )}
      </div>
      </div>
    </div>

// import { LocateOffIcon, ShieldCheck, KeyRound, Lock } from 'lucide-react';
...
//   // Check password strength and requirements in real-time
//   useEffect(() => {
//     if (newPassword) {
//       const requirements = {
...
//   return (
//     <Settingpage1 icon={ShieldCheck} title={"Security Settings"}>
...
//                         <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 ${step >= stepNumber ? 'border-blue-500 bg-blue-500' : 'border-gray-600 bg-gray-800'} transition-all duration-300`}>
//                           <span className={`font-medium ${step >= stepNumber ? 'text-white' : 'text-gray-400'}`}>
//                             {stepNumber}
//                           </span>
//                         </div>
//                         <span className={`text-xs mt-1 ${step >= stepNumber ? 'text-blue-400' : 'text-gray-500'}`}>
//                           {stepNumber === 1 ? 'Verify' : 'Change'}
//                         </span>
//                       </div>
//                     ))}
//                   </div>
...
//                   </div>
//                 ) : (
//                   <form onSubmit={step === 1 ? handleVerify : handleChangePassword}>
//                     {step === 1 ? (
...
//                           type="submit"
//                           disabled={loading}
//                           className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg font-medium flex items-center justify-center transition-colors duration-300"
//                         >
//                           {loading ? (
//                             <>

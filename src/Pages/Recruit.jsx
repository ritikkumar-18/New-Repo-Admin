...
// import { MessageSquare, X, Send, FileText, Phone, Mail, User, Briefcase, Calendar } from "lucide-react"
...
//     setSelectedApplicant(applicant)
//     setShowChat(true)
//     // Load previous messages or initialize empty chat
//     setChatMessages([
//       {
//         sender: "system",
...
//         text: `Thanks for your message. This is an automated response from ${selectedApplicant.name}.`,
//         time: new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }),
//       }
...
//                 <h2 className="text-xl font-bold text-gray-800">Offer Letter Template</h2>
...
//                   <p>
//                     This position offers an annual salary of $[SALARY], with benefits including health insurance,
//                     retirement plan, and [NUMBER] days of paid time off per year. Your anticipated start date will be
//                     [START DATE].
//                   </p>

//                   <p>
//                     Please review the attached documents for more details about your compensation package, benefits, and
//                     company policies. To accept this offer, please sign and return this letter by [RESPONSE DATE].
//                   </p>
...
//                   Close
//                 </button>
//                 <button className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Edit Template</button>
//                 <button className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">Send Offer</button>
//               </div>
//             </motion.div>
//           </motion.div>
//         )}
...
//           >
//             <motion.div
//               className="bg-gray-900 rounded-lg shadow-xl w-full max-w-md h-[80vh] flex flex-col"
//               initial={{ scale: 0.9, y: 20 }}
//               animate={{ scale: 1, y: 0 }}
//               exit={{ scale: 0.9, y: 20 }}
//             >
...
//                     <p className="text-xs text-gray-300">{selectedApplicant.position}</p>
//                   </div>
//                 </div>
...
//               {/* Chat Input */}
//               <div className="p-3 border-t bg-white text-black rounded-b-lg">
...
// import { motion, AnimatePresence } from "framer-motion"
// import {MessageSquare,X,Send,FileText,Phone,Mail,User,Briefcase,Calendar,Edit,Smile,Paperclip,Image,Download,Copy,} from "lucide-react"
...
//   // Function to handle file attachment in chat
...
//   // Function to copy offer letter to clipboard

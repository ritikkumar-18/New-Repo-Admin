...
//                   <th className="p-4 text-left  md:table-cell">Phone</th>
//                   <th className="p-4 text-left  md:table-cell">Email</th>
//                   <th className="p-4 text-left">Department</th>
//                   <th className="p-4 text-left  md:table-cell">Profession</th>
//                   <th className="p-4 text-left  lg:table-cell">Job Type</th>
//                   <th className="p-4 text-left  lg:table-cell">Location</th>
...
//                     <td className="p-4  md:table-cell">{candidate.email}</td>
//                     <td className="p-4">{candidate.department}</td>
//                     <td className="p-4  md:table-cell">{candidate.profession}</td>
//                     <td className="p-4  lg:table-cell">
//                       <span className="px-3 py-1 rounded-full text-sm bg-purple-900/40 text-purple-400">
//                         {candidate.jobType}
//                       </span>
//                     </td>
//                     <td className="p-4  lg:table-cell">{candidate.location}</td>
//                     <td className="p-4">
                  ...
                  <div className="bg-gray-800 rounded-xl p-5 border border-gray-700 shadow-lg">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedCandidate.skills.map((skill, index) => (
                        <span
                          key={index}
                          className="px-3 py-1 rounded-full text-sm bg-gradient-to-r from-purple-900/30 to-indigo-900/30 text-purple-400 border border-purple-800/50"
                        >
                          {skill}
                        </span>
                      ))}

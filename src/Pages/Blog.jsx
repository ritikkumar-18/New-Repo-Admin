...
//     { id: "flower", name: "Flower", icon: <Sparkles size={20} /> },
//     { id: "nature", name: "Nature", icon: <ImageIcon size={20} /> },
//     { id: "wallpapers", name: "Wallpapers", icon: <Monitor size={20} /> },
//     { id: "beach", name: "Beach", icon: <ImageIcon size={20} /> },
//     { id: "business", name: "Business", icon: <Users size={20} /> },
//   ]

//   // Sample trending tags
//   const trendingTags = ["flower", "spring", "beach", "nature", "wallpaper", "food", "family"]
...
//       category: "beach",
//       tags: ["ocean", "aerial", "blue", "waves", "beach"],
//       downloads: 1245,
//       likes: 342,
//       featured: true,
//     },
...
//       url: "https://images.unsplash.com/photo-1457089328109-e5d9bd499191",
//       photographer: "Emma Johnson",
//       category: "flower",
//       tags: ["flower", "pink", "macro", "nature", "spring"],
//       downloads: 987,
//       likes: 256,
//       featured: false,
//     },
...
//       category: "nature",
//       tags: ["mountain", "sunset", "landscape", "nature", "wallpaper"],
//       downloads: 1876,
//       likes: 543,
//       featured: true,
//     },
...
//       category: "wallpapers",
//       tags: ["abstract", "blue", "waves", "wallpaper", "digital"],
//       downloads: 2341,
//       likes: 678,
//       featured: false,
//     },
//     {
//       id: 5,
//       title: "Sandy Beach with Footprints",
//       url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e",
//       photographer: "David Park",
//       category: "beach",
//       tags: ["beach", "sand", "footprints", "ocean", "summer"],
//       downloads: 1543,
//       likes: 421,
//       featured: false,
//     },
...
//       category: "nature",
//       tags: ["forest", "autumn", "path", "trees", "nature"],
//       downloads: 1765,
//       likes: 432,
//       featured: false,
//     },
...
//       category: "beach",
//       tags: ["tropical", "beach", "paradise", "palm", "ocean"],
//       downloads: 2876,
//       likes: 765,
//       featured: true,
//     },
...
//       category: "business",
//       tags: ["team", "collaboration", "business", "people", "office"],
//       downloads: 1432,
//       likes: 321,
//       featured: false,
//     },
...
//     const timer = setTimeout(() => {
//       setIsLoading(false)
//       // Set a random featured photo
//       const featuredPhotos = photos.filter((photo) => photo.featured)
//       if (featuredPhotos.length > 0) {
//         setFeaturedPhoto(featuredPhotos[Math.floor(Math.random() * featuredPhotos.length)])
//       } else {
...
//   return (
//     <div className="flex-1 overflow-auto relative z-10 bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen text-white">
//       <Toaster />
//       <Header title="StockSnap.io" />
...
//             style={{
//               backgroundImage: `url(${featuredPhoto?.url || "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05"})`,
//             }}
//           >
...
//           <div className="flex justify-between items-center">
//             <div className="flex items-center">
//               <div className="text-xl font-bold mr-8">StockSnap.io</div>
...
//                 className="w-full py-3 pl-10 pr-4 rounded-lg bg-white text-gray-900 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50"
//               />
...
//               Featured photo by {featuredPhoto?.photographer || "Kelly Ishmael"}
//             </div>
//             <a
//               href="#"
//               className="text-xs bg-gray-800/70 hover:bg-gray-700 text-white px-3 py-1 rounded-full flex items-center transition-colors"
//             >
//               Get 15% off at Shutterstock with code: STOCKSNAP15
...
//                             handleLike(photo.id)
//                           }}
//                           className="p-2 bg-gray-800/80 backdrop-blur-sm rounded-full text-gray-300 hover:text-white hover:bg-purple-600/80 transition-colors"
...
//             <button className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-6 py-3 rounded-lg shadow-lg shadow-purple-900/20 transition-colors">
//               Load More Photos
//             </button>
//           </div>
//         )}
...
//           <div className="fixed right-0 top-0 h-full w-full md:w-96 bg-gray-800 p-6 shadow-xl z-50 overflow-y-auto">
//             <div className="flex justify-between items-center mb-6">
//               <h2 className="text-xl font-semibold text-white">Filters & Sorting</h2>
//               <button
...
//               <div className="text-xl font-bold mb-2">StockSnap.io</div>
//               <p className="text-gray-400 text-sm">Beautiful free stock photos</p>
//             </div>
...
//             © {new Date().getFullYear()} StockSnap.io. All rights reserved.
//           </div>
//         </div>
//       </footer>
//     </div>
